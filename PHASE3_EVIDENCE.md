...
- Stale entries require review before reuse; restoration reopens the original dataset, selects the original resource, requires explicit loading, compares the current schema/digest, and never silently reruns historical SQL.
...
- `npm run test:browser`: 12 passing tests across Chromium and Firefox, including the sample, three CNRA fixtures, postal/FIPS preservation, and history reload/export.
